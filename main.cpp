...
int main() {
    // cv::Mat color = cv::imread("../Screenshot_2021-02-25_15_17_39_120993.jpg");
...
//    cv::namedWindow("HSV"); cv::imshow("HSV", hsv>0);

    cv::Mat mask;
    // mask of green (36,25,25) ~ (86, 255,255)
    // mask = cv2.inRange(hsv, (36, 25, 25), (86, 255,255))
    cv::inRange(hsv, cv::Scalar(50, 25, 25), cv::Scalar(70, 255,255), mask);
    cv::namedWindow("mask"); cv::imshow("mask", mask>0);

    // compute canny (don't blur with that image quality!!)
    cv::Canny(mask, canny, 200,20);
...
//    return 0;
    ...
    cv::HoughCircles( mask, circles, cv::HOUGH_GRADIENT, 1, 60, 200, 20, 10, 0 );
